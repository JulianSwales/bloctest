...
class JSDateTimePicker extends StatefulWidget {
  JSDateTimePicker(
      {Key key,
      this.labelText,
      this.selectedDate,
  ...
  @override
  _JSDateTimePickerState createState() => _JSDateTimePickerState();
}

class _JSDateTimePickerState extends State<JSDateTimePicker> {
  Future<void> _selectDate(BuildContext context) async {
    final DateTime picked = await showDatePicker(
        context: context,
        ...
        firstDate: new DateTime(1970, 8),
        lastDate: new DateTime(2101));
    if (picked != null && picked != widget.selectedDate) widget.selectDate(picked);
    print('picked: ${picked}');
    setState(() {
